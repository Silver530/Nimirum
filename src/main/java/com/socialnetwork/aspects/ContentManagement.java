...
public class ContentManagement {
    ...
    @After("execution(* com.socialnetwork.controller.PostController.addPost(..))")
    ...
    @After("execution(* com.socialnetwork.controller.AdminController.processPost(..))")
