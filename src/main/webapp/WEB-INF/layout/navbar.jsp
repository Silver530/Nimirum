    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <div class="notification-box noti" id="notification" style="border-bottom: 4px solid #785292">
            <c:forEach items="${notifications}" var="item">
            <div class="nott-list">
                <div class="notfication-details">
                    <div class="notification-info">
                        <h3 style="width: 100%;"><a href="/profile/${item.post.user.id}?scrollTo=${item.post.id}" title="" style="text-transform: capitalize;">${item.post.user.profile.firstName} ${item.post.user.profile.lastName}</a> new post. <br><br></h3>
