                            ...
                            <div class="main-left-sidebar">
                                <div class="user_profile">
                                    ...
                                    <div class="user_pro_status">
                                        <c:if test="${follow==0}">
                                            <ul class="flw-hr">
                                                <li><a href="javascript:" title="" class="flww follow" id="${profile.id}">Подписаться</a></li>
                                            </ul>
                                        </c:if>
                                        <c:if test="${follow==1}">
                                            <ul class="flw-hr">

                                                <li><a href="javascript:" title="" class="flww unfollowing" id="${profile.id}">Отписаться</a></li>
